...
/******/ 	var hotCurrentHash = "f9d6eddb1cbd709875c9"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _products = __webpack_require__(170);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CatMain = function (_React$Component) {
	    _inherits(CatMain, _React$Component);
	
	    function CatMain(props) {
	        _classCallCheck(this, CatMain);
	
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CatMain).call(this, props));
	        ...
	        _this.handlerSelect = _this.handlerSelect.bind(_this);
	        _this.handlerRemove = _this.handlerRemove.bind(_this);
	        return _this;
	    }
	
	    _createClass(CatMain, [{
	        ...
	        value: function handlerClick(event) {
	            ...
	            if (this.state.value != "") {
	                fetch('http://localhost:3000/api/category/add', {
	                    ...
	                    _this3.handlerLoad();
	                    _this3.setState({ value: '', removeDisabled: true, removeSelect: '' });
	                });
	            } else {
	        ...
	        value: function handlerRemove(event) {
	            ...
	            if (this.state.removeSelect != "") {
	                fetch('http://localhost:3000/api/category/remove', {
	                    ...
	                    alert(result.message);
	                    _this4.handlerLoad();
	                    _this4.setState({ value: '', removeDisabled: true, removeSelect: '' });
	                });
	            } else {
	        ...
	        key: 'handlerSelect',
	        value: function handlerSelect(event) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_button2.default, { type: 'button', 'class': 'btn btn-primary btn-flat', title: 'ADD', click: this.handlerClick }),
	                    _react2.default.createElement(_button2.default, { type: 'button', 'class': 'btn btn-primary btn-flat', title: 'REMOVE', disabled: this.state.removeDisabled, click: this.handlerRemove })
	                ),
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'ul',
	                        null,
	                        this.state.list.map(function (d, index) {
	                            return _react2.default.createElement(
	                                'li',
	                                { key: index },
	                                _react2.default.createElement(
	                                    'a',
	                                    { 'data-cat-name': d.name, 'data-cat-id': d._id, onClick: _this5.handlerSelect, href: 'javascript:void(0)' },
	                                    d.name
	                                )
	                            );
	                        })
	...
	_reactDom2.default.render(_react2.default.createElement(CatMain, null), document.getElementById("todo-cat"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductAdd = function (_React$Component) {
	    ...
	    function ProductAdd(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ProductAdd).call(this, props));
	        ...
	        value: function handlerClick(event) {
	            ...
	            if (this.state.name != '' && this.state.amount != 0 && this.state.price != 0) {
	                fetch('http://localhost:3000/api/stock/add', {
	                    ...
	                    alert(result.message);
	                    _this3.handlerLoad();
	                    _this3.setState({ name: '', catSelect: '', amount: 0, price: 0, removeDisabled: true, removeSelect: '' });
	                });
	            }
	        }
	    }, {
	        ...
	        value: function handlerRemove(event) {
	            ...
	            if (this.state.removeSelect != "") {
	                fetch('http://localhost:3000/api/stock/remove', {
	                    ...
	                    alert(result.message);
	                    _this4.handlerLoad();
	                    _this4.setState({ name: '', catSelect: '', amount: 0, price: 0, removeDisabled: true, removeSelect: '' });
	                });
	            } else {
	                alert("Please select category");
	            }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_input2.default, {
	                            ...
	                            state: 'price',
	                            change: this.handlerChange }),
	                        _react2.default.createElement(_select2.default, { source: 'http://localhost:3000/api/categories', method: 'get', 'class': 'form-control input-flat', state: 'catSelect',
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'ul',
	                        null,
	                        this.state.productList.map(function (d, index) {
	                            return _react2.default.createElement(
	                                'li',
	                                { key: index },
	                                _react2.default.createElement(
	...
	_reactDom2.default.render(_react2.default.createElement(ProductAdd, null), document.getElementById('todo-pro'));
